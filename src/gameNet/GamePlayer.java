 ...
 * <p>
 * Other key methods in GamePlayer are <b>joinGame</b> for creating the connection
 * to the GameControl, and <b>exitGame</b> to terminate the connection. 
 */
    ...
    implements Serializable
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 6585401884649563537L;
     ...
     * ObjectOutputStream from the GameControl.   Every GameOutputObj
     * read from the ObjectOutputStream is passed on
     * by calling the receivedMessage routine.  This routine shouldn't be 
     * accessed directly from gameControl code.  It has to be public to properly run
     * as a thread. 
     */  
  public void run()
  {
   ...
   */
    ...
    */
     ...
     * @param GameInputObj to pass to the GameControl. 
     */
    public void sendMessage(Object ob)
    {
     try{
            ...
            {
                socketOutput.writeObject(ob); // Write to socket
                socketOutput.reset();
            }
         }
      catch (IOException e)
     ...
     * @param ob  Object received from the GameControl
     */
    
    protected void receivedMessage(Object ob)
    {
    	userInterface.receivedMessage(ob);       
    }
